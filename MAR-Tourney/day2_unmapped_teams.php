...
$sql = "select distinct a.participant as participant FROM donkey_day2 a LEFT JOIN tourney_teams b ON a.participant=b.participant WHERE b.participant IS NULL AND a.participant !='Participant'";
