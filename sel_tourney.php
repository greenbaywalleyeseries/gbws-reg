  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-section">
	    <div class="col-12 col-md-12">
	       <form name="TourneyForm" id="TourneyForm" action="https://www.sandbox.paypal.com/cgi-bin/webscr" onsubmit="formValidation('<?php echo $team_id;?>')"  method="post">
            <!--<form name="TourneyForm" id="TourneyForm" action="https://www.paypal.com/cgi-bin/webscr" onsubmit="formValidation('X')"  method="post"> -->
