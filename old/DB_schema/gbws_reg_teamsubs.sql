...
--
-- Table structure for table `teamsubs`
--
...
CREATE TABLE `teamsubs` (
  ...
  `sub_state` varchar(2) DEFAULT NULL,
  `sub_zip` char(5) CHARACTER SET utf8 DEFAULT NULL,
  `sub_phone` char(20) CHARACTER SET utf8 DEFAULT NULL,
  `sub_email` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`sub_id`),
  KEY `fk_team` (`team_id`),
  CONSTRAINT `fk_team` FOREIGN KEY (`team_id`) REFERENCES `teaminfo` (`team_id`) ON DELETE CASCADE ON UPDATE CASCADE
