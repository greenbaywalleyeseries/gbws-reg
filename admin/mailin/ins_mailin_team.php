...
$ins_sql="INSERT INTO team_info (team_id, partner1, partner2, sub1, sub2, paid, refund, boat, motor, trolling_motor, electronics) VALUES('$team_id', '$partner1_mbr_id', '$partner2_mbr_id', '$sub1_mbr_id', '$sub2_mbr_id', 'X', '$refund', '$boat', '$motor', '$trolling_motor', '$electronics')";
//echo $ins_sql;
