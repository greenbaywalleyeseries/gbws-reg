...
<body>
   ...
   <div class="divider"/>
       	<a href="reg_fish.php" class="button">Enter Fish</a>
   <div class="divider"/>
       	<a href="leader_after_weigh_in_pdf.php" class="button">Current Standings</a>
   <div class="divider"/>
    	<a href="leader_pdf.php" class="button">Current Standings (admin only)</a>
   <div class="divider"/>
   ...
   <div class="divider"/>
	...
	<div class="divider"/>
        <a href="final_results_pdf.php" class="button">Generate Final Results</a>
   <div class="divider"/>
