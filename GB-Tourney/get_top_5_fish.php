...
//Get Day 1 Results
$day1_sql = "SELECT * FROM reg_fish where boat_num=".$_GET['boat_num']." and date='".$day1."' order by weight desc limit 5";
...
//Get Day 2 Results
$day2_sql = "SELECT * FROM reg_fish where boat_num=".$_GET['boat_num']." and date='".$day2."' order by weight desc limit 5";
