...
if("" == trim($_POST['partner1_first'])){
	...
	$ins_sql="INSERT INTO member_info (mbr_id, first, last, address, city, state, zip, phone, email) VALUES('$partner1_mbr_id', '$partner1_first', '$partner1_last', '$partner1_address', '$partner1_city', '$partner1_state', '$partner1_zip', '$partner1_phone', '$partner1_email')";
	$rc=reg_mbr($ins_sql);
	$reg_size+=1;
}
...
if("" == trim($_POST['partner2_first'])){
	...
	$ins_sql="INSERT INTO member_info (mbr_id, first, last, address, city, state, zip, phone, email) VALUES('$partner2_mbr_id', '$partner2_first', '$partner2_last', '$partner2_address', '$partner2_city', '$partner2_state', '$partner2_zip', '$partner2_phone', '$partner2_email')";
	$rc=reg_mbr($ins_sql);
	$reg_size+=1;
}
...
if("" == trim($_POST['sub1_first'])){
	...
	$ins_sql="INSERT INTO member_info (mbr_id, first, last, address, city, state, zip, phone, email) VALUES('$sub1_mbr_id', '$sub1_first', '$sub1_last', '$sub1_address', '$sub1_city', '$sub1_state', '$sub1_zip', '$sub1_phone', '$sub1_email')";
	$rc=reg_mbr($ins_sql);
	$reg_size+=1;
}
...
if("" == trim($_POST['sub2_first'])){
	...
	$ins_sql="INSERT INTO member_info (mbr_id, first, last, address, city, state, zip, phone, email) VALUES('$sub2_mbr_id', '$sub2_first', '$sub2_last', '$sub2_address', '$sub2_city', '$sub2_state', '$sub2_zip', '$sub2_phone', '$sub2_email')";
	$rc=reg_mbr($ins_sql);
	$reg_size+=1;
}  
...
$ins_sql="INSERT INTO team_info (team_id, partner1, partner2, sub1, sub2) VALUES('$team_id', '$partner1_mbr_id', '$partner2_mbr_id', '$sub1_mbr_id', '$sub2_mbr_id')";
//echo $ins_sql;
